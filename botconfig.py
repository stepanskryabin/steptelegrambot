...
FORMAT MESSAGE:
    ...
    {9} - speed_wing
"""
CURRENT_WEATHER_MESSAGE = "Сейчас в {1} <b><i>{2}</i></b> {3}\
    \nТемпература: <b>{4} C.</b>\
    \nЧувствуется как: <b>{5} C.</b>\
    \nДавление: <b>{6} мм.рт.ст.</b>\
    \nВлажность: <b>{7} %.</b>\
    \nОблачность: <b>{8} %.</b>\
    \nСкорость ветра: < b > {9} метров в сек. < / b > "

FORECAST_WEATHER_MESSAGE = "Сейчас в {1} <b><i>{2}</i></b> {3}\
    \nТемпература: <b>{4} C.</b>\
    \nЧувствуется как: <b>{5} C.</b>\
    \nДавление: <b>{6} мм.рт.ст.</b>\
    \nВлажность: <b>{7} %.</b>\
...
ONECALL_WEATHER_MESSAGE = "Сейчас в {1} <b><i>{2}</i></b> {3}\
    \nТемпература: <b>{4} C.</b>\
    \nЧувствуется как: <b>{5} C.</b>\
    \nДавление: <b>{6} мм.рт.ст.</b>\
    \nВлажность: <b>{7} %.</b>\
...
USER_NOT_EXIST = "Пользователя: {1} с ID: {2} не существует."
